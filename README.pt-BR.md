...
E o assistente não fica preso à sua mesa. Faça login pelo celular — ou por um aplicativo de mensagens que você já usa — e você alcança o mesmo assistente que vive no seu computador. O servidor de retransmissão apenas repassa mensagens; não guarda dados nem aplicativos.
