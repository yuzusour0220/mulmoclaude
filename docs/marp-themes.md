...
`config/marp-themes/corporate.css` を 1 つ置けば、ワークスペース内のすべての Marp スライドが `theme: corporate` で同じ見た目を共有できます。テーマを更新すれば、参照しているすべてのスライドに反映されます (更新の反映は[後述](#%E5%88%B6%E9%99%90))。
